...
INSERT INTO beers (id, brewery_name, name, description, style, ibu, srm, abv)
VALUES (2, 'Budweiser', 'Douchbag Pale Ale', "Nullam luctus, tellus id faucibus blandit, augue tortor vestibulum tellus, tincidunt tristique massa velit at ipsum. Phasellus luctus sapien at rutrum efficitur. Maecenas sed auctor diam. Vivamus laoreet vitae erat ut commodo. Suspendisse hendrerit at libero nec pellentesque. Integer purus urna, vehicula vitae interdum eget, mattis ac eros. Cras dictum risus sit amet purus facilisis pellentesque.", 'Pale Ale', '60', '6', '4.5');

INSERT INTO beers (id, brewery_name, name, description, style, ibu, srm, abv)
VALUES (3, 'Fucking Brewery', 'The Fat Cow', 'Vivamus sollicitudin vitae nisl et maximus. Nunc vel leo venenatis, elementum felis in, accumsan felis. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Maecenas semper nibh arcu, vitae iaculis nibh mollis id.', 'Stout', '30', '50', '6.5');
